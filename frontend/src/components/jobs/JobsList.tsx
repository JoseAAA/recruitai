        ...
        <div className={`rounded-xl border ${meta.border} ${meta.bg} p-5 transition-all`}>
            ...
            <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700/50">
                <Link
                    ...
                    className="flex items-center justify-center gap-2 w-full px-4 py-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 text-sm font-medium hover:bg-primary hover:text-white hover:border-primary transition-all"
                >
                    Ver perfil completo
